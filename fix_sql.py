...
CREATE TABLE public.leave_applications (
  ...
  CONSTRAINT leave_applications_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id),
  CONSTRAINT leave_applications_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id),
  CONSTRAINT leave_applications_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT leave_applications_replacement_faculty_id_fkey FOREIGN KEY (replacement_faculty_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.faculty_assignments (
  ...
  CONSTRAINT faculty_assignments_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id)
);
CREATE TABLE public.course_materials (
  ...
  CONSTRAINT course_materials_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id)
);
CREATE TABLE public.academic_history (
  ...
  CONSTRAINT academic_history_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.exams (
  ...
  CONSTRAINT exams_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.exam_rooms(id),
  CONSTRAINT exams_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.subjects(id)
);
CREATE TABLE public.admit_cards (
  ...
  CONSTRAINT admit_cards_exam_id_fkey FOREIGN KEY (exam_id) REFERENCES public.exams(id),
  CONSTRAINT admit_cards_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
CREATE TABLE public.admin_notices (
  ...
  CONSTRAINT admin_notices_author_id_fkey FOREIGN KEY (author_id) REFERENCES auth.users(id)
);
CREATE TABLE public.student_experiences (
  ...
  CONSTRAINT student_experiences_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
CREATE TABLE public.noc_requests (
  ...
  CONSTRAINT noc_requests_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
CREATE TABLE public.practical_training_logs (
  ...
  CONSTRAINT practical_training_logs_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.memorial_vault (
  ...
  CONSTRAINT memorial_vault_author_id_fkey FOREIGN KEY (author_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.elective_bids (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  student_id uuid,
  subject_id uuid,
  faculty_id uuid,
  ...
  CONSTRAINT elective_bids_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id),
  CONSTRAINT elective_bids_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id)
);
CREATE TABLE public.batch_credential_logs (
  ...
  CONSTRAINT batch_credential_logs_dispatched_by_fkey FOREIGN KEY (dispatched_by) REFERENCES auth.users(id)
);
CREATE TABLE public.disciplinary_logs (
  ...
  CONSTRAINT disciplinary_logs_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id),
  CONSTRAINT disciplinary_logs_logged_by_fkey FOREIGN KEY (logged_by) REFERENCES auth.users(id)
);
CREATE TABLE public.legal_aid_cases (
  ...
  CONSTRAINT legal_aid_cases_assigned_student_id_fkey FOREIGN KEY (assigned_student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.moot_bids (
  ...
  CONSTRAINT moot_bids_moot_id_fkey FOREIGN KEY (moot_id) REFERENCES public.moot_competitions(id),
  CONSTRAINT moot_bids_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.cle_diaries (
  ...
  CONSTRAINT cle_diaries_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
CREATE TABLE public.student_marks (
  ...
  CONSTRAINT student_marks_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id),
  CONSTRAINT student_marks_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id)
);
CREATE TABLE public.bidding_phases (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  status character varying DEFAULT 'active'::character varying,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT bidding_phases_pkey PRIMARY KEY (id)
);
CREATE TABLE public.student_bidding_wallets (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  student_id uuid,
  phase_id uuid,
  total_points integer DEFAULT 1000,
  used_points integer DEFAULT 0,
  CONSTRAINT student_bidding_wallets_pkey PRIMARY KEY (id),
  CONSTRAINT student_bidding_wallets_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id),
  CONSTRAINT student_bidding_wallets_phase_id_fkey FOREIGN KEY (phase_id) REFERENCES public.bidding_phases(id)
);
CREATE TABLE public.elective_catalog (
  id character varying NOT NULL,
  phase_id uuid,
  course_name character varying NOT NULL,
  professor_name character varying,
  capacity integer DEFAULT 60,
  current_min_bid integer DEFAULT 0,
  tags jsonb DEFAULT '[]'::jsonb,
  CONSTRAINT elective_catalog_pkey PRIMARY KEY (id),
  CONSTRAINT elective_catalog_phase_id_fkey FOREIGN KEY (phase_id) REFERENCES public.bidding_phases(id)
);
CREATE TABLE public.bidding_ledger (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  student_id uuid,
  phase_id uuid,
  elective_id character varying,
  bid_amount integer NOT NULL,
  status character varying DEFAULT 'pending'::character varying,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT bidding_ledger_pkey PRIMARY KEY (id),
  CONSTRAINT bidding_ledger_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id),
  CONSTRAINT bidding_ledger_phase_id_fkey FOREIGN KEY (phase_id) REFERENCES public.bidding_phases(id),
  CONSTRAINT bidding_ledger_elective_id_fkey FOREIGN KEY (elective_id) REFERENCES public.elective_catalog(id)
);
CREATE TABLE public.student_documents (
  ...
  CONSTRAINT student_documents_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.faculty_profiles (
  ...
  CONSTRAINT faculty_profiles_id_fkey FOREIGN KEY (id) REFERENCES public.profiles(id)
);
CREATE TABLE public.class_substitutions (
  ...
  CONSTRAINT class_substitutions_original_faculty_id_fkey FOREIGN KEY (original_faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT class_substitutions_substitute_faculty_id_fkey FOREIGN KEY (substitute_faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT class_substitutions_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.class_schedule(id)
);
CREATE TABLE public.exam_eligibility (
  ...
  CONSTRAINT exam_eligibility_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id),
  CONSTRAINT exam_eligibility_exam_id_fkey FOREIGN KEY (exam_id) REFERENCES public.exams(id)
);
...
CREATE TABLE public.roster_unlocks (
  ...
  faculty_id uuid,
  subject_id uuid,
  batch_ids ARRAY DEFAULT '{}'::uuid[],
  date date NOT NULL,
  status text DEFAULT 'pending'::text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT roster_unlocks_pkey PRIMARY KEY (id),
  CONSTRAINT roster_unlocks_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id)
);
CREATE TABLE public.timetable_reschedules (
  ...
  CONSTRAINT timetable_reschedules_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES auth.users(id),
  CONSTRAINT timetable_reschedules_timetable_id_fkey FOREIGN KEY (timetable_id) REFERENCES public.class_schedule(id)
);
CREATE TABLE public.mentorship_timeline (
  ...
  CONSTRAINT mentorship_timeline_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.internship_requests (
  ...
  CONSTRAINT internship_requests_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.research_submissions (
  ...
  CONSTRAINT research_submissions_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.faculty_availability (
  ...
  CONSTRAINT faculty_availability_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.student_metrics (
  ...
  CONSTRAINT student_metrics_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.student_deadlines (
  ...
  CONSTRAINT student_deadlines_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.academic_semesters (
  ...
  CONSTRAINT academic_semesters_academic_year_id_fkey FOREIGN KEY (academic_year_id) REFERENCES public.academic_years(id)
);
...
CREATE TABLE public.subjects (
  ...
  faculty_id uuid,
  created_at timestamp with time zone DEFAULT now(),
  batches ARRAY DEFAULT '{}'::text[],
  CONSTRAINT subjects_pkey PRIMARY KEY (id),
  CONSTRAINT subjects_semester_id_fkey FOREIGN KEY (semester_id) REFERENCES public.academic_semesters(id),
  CONSTRAINT subjects_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.subject_modules (
  ...
  CONSTRAINT subject_modules_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id)
);
CREATE TABLE public.timetable_changes (
  ...
  CONSTRAINT timetable_changes_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id),
  CONSTRAINT timetable_changes_new_room_id_fkey FOREIGN KEY (new_room_id) REFERENCES public.academic_classrooms(id)
);
CREATE TABLE public.notice_bookmarks (
  ...
  CONSTRAINT notice_bookmarks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.notice_acknowledgements (
  ...
  CONSTRAINT notice_acknowledgements_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.timetable_requests (
  ...
  CONSTRAINT timetable_requests_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT timetable_requests_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id)
);
CREATE TABLE public.class_sessions (
  ...
  CONSTRAINT class_sessions_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.marks_ledger (
  ...
  CONSTRAINT marks_ledger_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT marks_ledger_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id),
  CONSTRAINT marks_ledger_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.course_resources (
  ...
  CONSTRAINT course_resources_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT course_resources_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id)
);
...
CREATE TABLE public.helpdesk_messages (
  ...
  CONSTRAINT helpdesk_messages_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.helpdesk_attachments (
  ...
  CONSTRAINT helpdesk_attachments_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.helpdesk_messages(id)
);
CREATE TABLE public.mentorship (
  ...
  CONSTRAINT mentorship_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT mentorship_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.mentorship_meetings (
  ...
  CONSTRAINT mentorship_meetings_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT mentorship_meetings_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.grievances (
  ...
  CONSTRAINT grievances_reporter_id_fkey FOREIGN KEY (reporter_id) REFERENCES public.profiles(id),
  CONSTRAINT grievances_accused_id_fkey FOREIGN KEY (accused_id) REFERENCES public.profiles(id),
  CONSTRAINT grievances_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES public.profiles(id)
);
CREATE TABLE public.helpdesk_tickets (
  ...
  CONSTRAINT helpdesk_tickets_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.fee_ledger (
  ...
  CONSTRAINT fee_ledger_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.student_courses (
  ...
  CONSTRAINT student_courses_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.subjects(id)
);
CREATE TABLE public.assignments (
  ...
  CONSTRAINT assignments_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id),
  CONSTRAINT assignments_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.subjects(id)
);
...
CREATE TABLE public.exam_results (
  ...
  CONSTRAINT exam_results_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id),
  CONSTRAINT exam_results_examination_id_fkey FOREIGN KEY (examination_id) REFERENCES public.exams(id)
);
CREATE TABLE public.internships (
  ...
  CONSTRAINT internships_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.achievements (
  ...
  CONSTRAINT achievements_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.legal_clinics (
  ...
  CONSTRAINT legal_clinics_faculty_in_charge_fkey FOREIGN KEY (faculty_in_charge) REFERENCES public.profiles(id)
);
CREATE TABLE public.clinic_registrations (
  ...
  CONSTRAINT clinic_registrations_clinic_id_fkey FOREIGN KEY (clinic_id) REFERENCES public.legal_clinics(id),
  CONSTRAINT clinic_registrations_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.class_schedule (
  ...
  CONSTRAINT class_schedule_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id),
  CONSTRAINT class_schedule_room_id_fkey FOREIGN KEY (room_id) REFERENCES public.academic_classrooms(id),
  CONSTRAINT class_schedule_faculty_id_fkey FOREIGN KEY (faculty_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.profile_update_requests (
  ...
  CONSTRAINT profile_update_requests_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.erp_password_reset_requests (
  ...
  CONSTRAINT erp_password_reset_requests_resolved_by_fkey FOREIGN KEY (resolved_by) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.fee_invoices (
  ...
  CONSTRAINT fee_invoices_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
CREATE TABLE public.fee_transactions (
  ...
  CONSTRAINT fee_transactions_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.academic_records (
  ...
  CONSTRAINT academic_records_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.campus_activity_logs (
  ...
  CONSTRAINT campus_activity_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
"""
...
for block in tables:
    ...
    for i, line in enumerate(lines):
        if "FOREIGN KEY" in line:
            # Clean up trailing comma for parsing if needed
            c_line = line.strip().rstrip(",")
            constraints.append(f"ALTER TABLE {table_name} ADD {c_line};")
        else:
            new_lines.append(line)
    
    # Fix trailing comma in the line before the closing parenthesis
