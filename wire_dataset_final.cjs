...
async function run() {
    ...
    const batchId = 'eb65f020-2a43-435d-bc2d-dae983a16b7f'; // LLB (Class of 2029)
    ...
    // 2. Setup cohort_subjects for LLB (Class of 2029)
    ...
    const cohorts = [
        ...
        { batch_id: batchId, faculty_id: facultyId, master_subject_id: sub2.id },
        { batch_id: batchId, faculty_id: facultyId, master_subject_id: sub3.id }
    ];
    ...
    // 3. Setup Class Schedule (Wiring Timetables for Section I & II)
    ...
    const schedules = [
        ...
        { faculty_id: facultyId, subject_id: sub3.id, batch: 'LLB Section I', day_of_week: 'Friday', start_time: '09:00:00', end_time: '10:00:00', status: 'Scheduled', room_id: roomId },
        ...
        { faculty_id: facultyId, subject_id: sub3.id, batch: 'LLB Section II', day_of_week: 'Friday', start_time: '11:00:00', end_time: '12:00:00', status: 'Scheduled', room_id: roomId },
    ];
    ...
    const end = new Date("2026-09-20T00:00:00Z"); // User said "to Sep 20"
        ...
        insertedSchedules.forEach(sch => {
            if (dayMap[sch.day_of_week] === dayInt) {
                ...
                sessionsToInsert.push({
                    ...
                    date: dateStr,
                    status: 'completed', // They show up as past unmarked classes
