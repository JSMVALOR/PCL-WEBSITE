...
-- 4. Inject Dummy Notifications to test the UI!
DO $$
DECLARE
    test_user_id UUID;
BEGIN
    -- This grabs the very first profile in the database.
    -- Change the email here to your active test account if you want it sent directly to you:
