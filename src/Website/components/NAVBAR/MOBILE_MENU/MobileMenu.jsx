              ...
              >
                ...
                <div className="flex items-center justify-between p-6 border-b border-[var(--card-border)]">
                  <div className="flex flex-col">
                    <span className={`font-bold tracking-[0.2em] text-lg ${theme.text.primary}`}>PRUDENTIA</span>
                    <span className="text-[8px] tracking-[0.3em] uppercase text-[var(--accent)] font-bold">College of Law</span>
                  </div>
                  <button 
                    onClick={() => setIsOpen(false)}
