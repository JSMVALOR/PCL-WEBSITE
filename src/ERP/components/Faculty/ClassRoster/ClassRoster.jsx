...
export default function ClassRoster({ isEmbedded = false }) {
 ...
 <select 
 className="w-full appearance-none bg-themePanel/80 backdrop-blur-md border-theme border-themeBorder hover:border-themeBorderStrong text-themeText text-xs font-black px-4 py-3.5 rounded-themePanel outline-none cursor-pointer transition-colors"
 value={activeClass}
 ...
 <div className="flex items-center gap-3 mb-8 text-center bg-[#1a1a1a] px-5 py-2.5 rounded-lg border border-themeBorderStrong">
 ...
 <div className="w-full bg-[#1a1a1a] p-5 rounded-xl border border-themeBorderStrong">
 ...
 <div className="h-2 w-full bg-themeApp rounded-full overflow-hidden border border-themeBorder">
 ...
 className={`w-full sm:w-auto px-6 lg:px-8 py-3.5 lg:py-4 rounded-themePanel text-[10px] lg:text-xs font-black uppercase tracking-widest transition duration-300 flex items-center justify-center gap-2 overflow-hidden group ${isSaving || !isComplete
