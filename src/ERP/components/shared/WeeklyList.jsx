            ...
            {daysOrder.map(day => {
                ...
                return (
                    <div key={day} className="flex flex-col relative">
                        {/* Day Header */}
                        <div className="sticky top-0 z-20 bg-white/60 dark:bg-themePanel/60 backdrop-blur-3xl py-4 lg:py-5 border-b border-black/5 dark:border-white/5 mb-8 flex items-center justify-between shadow-[0_10px_30px_-15px_rgba(0,0,0,0.1)]">
                            <h2 className="text-2xl lg:text-3xl font-semibold tracking-tight text-themeText dark:text-themeText flex items-center gap-3">
                                {day}
                                <span className="text-[12px] font-bold px-3 py-1 rounded-lg bg-black/5 dark:bg-white/10 text-themeTextSec tracking-tight">
