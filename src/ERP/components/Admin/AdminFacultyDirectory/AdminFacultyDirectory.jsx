...
<button type="button"
 ...
 className="bg-themeAccent hover:bg-themeAccent/80 text-themeText dark:text-white px-6 py-3 rounded-xl text-[10px] lg:text-[14px] font-medium tracking-normal transition flex justify-center items-center gap-2 border border-themeBorder dark:border-white/5Accent/50 active:scale-[0.98]"
 >
 <i className="fa-solid fa-user-plus text-base"></i> Add New Faculty
 </button>
 </div>
 ...
 <div className="bg-white dark:bg-[#121212] border border-themeBorder dark:border-white/5 rounded-2xl p-12 text-center flex flex-col items-center justify-center min-h-[300px]">
 ...
 {faculties.map((fac) => (
 <div key={fac.id} className="bg-white dark:bg-[#121212] border border-themeBorder dark:border-white/5 rounded-2xl flex flex-col group hover:-translate-y-1 transition overflow-hidden">
 <div className="p-5 border-b border-themeBorder dark:border-white/5 bg-gray-100 dark:bg-themeApp/30 flex items-center justify-between">
 ...
 <img src={fac.faculty_profiles.image_url} alt={fac.full_name} className="w-12 h-12 rounded-xl object-cover border border-themeBorder dark:border-white/5 shrink-0" />
 ) : (
 <div className="w-12 h-12 bg-themeAccent/20 text-themeAccent border border-themeBorder dark:border-white/5Accent/30 rounded-xl flex items-center justify-center font-black text-lg shrink-0">
 ...
 className={`w-10 h-6 rounded-full p-1 transition-colors flex items-center border border-themeBorder dark:border-white/5 ${fac.faculty_profiles?.is_public ? 'bg-emerald-500/20 border-emerald-500/30' : 'bg-neutral-600/30'}`}
 ...
 <p className="text-sm font-bold bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-lg p-2.5 truncate text-themeText dark:text-white">{fac.department || 'N/A'}</p>
 </div>
 
 <div>
 <p className="text-[10px] uppercase font-black tracking-widest text-themeTextSec dark:text-white/50 mb-1 ml-1">Designation</p>
 <p className="text-sm font-bold bg-themeAccent/5 border border-themeBorder dark:border-white/5Accent/20 text-themeAccent rounded-lg p-2.5 truncate">{fac.faculty_profiles?.designation || 'N/A'}</p>
 </div>
 ...
 <p className="text-sm font-bold bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-lg p-2.5 truncate text-white/80">{fac.faculty_profiles?.specialisation || 'N/A'}</p>
 </div>
 </div>
 </div>
 ))}
 ...
 <div className="bg-white dark:bg-[#121212] w-full max-w-3xl border border-themeBorder dark:border-white/5 rounded-2xl flex flex-col max-h-[90vh] overflow-hidden">
 <div className="bg-gray-100 dark:bg-themeApp p-5 lg:p-6 text-themeText dark:text-white relative shrink-0 border-b border-themeBorder dark:border-white/5 flex justify-between items-center">
 <div>
 ...
 <button type="button" onClick={() => setShowModal(false)} className="w-10 h-10 bg-black hover:bg-neutral-800 rounded-full border border-themeBorder dark:border-white/5 flex items-center justify-center text-themeTextSec dark:text-white/50 hover:text-themeText dark:text-white transition-colors">
 ...
 <div className="bg-black text-emerald-400 p-5 rounded-xl text-left font-mono text-xs border border-themeBorder dark:border-white/5 max-h-48 overflow-y-auto mx-auto max-w-lg mb-8">
 {provisionLogs.map((log, i) => <div key={i} className="mb-1">&gt; {log}</div>)}
 </div>
 <button type="button" onClick={() => setShowModal(false)} className="bg-white dark:bg-[#121212] border border-themeBorder dark:border-white/5 hover:bg-gray-100 dark:bg-themeApp text-themeText dark:text-white px-8 py-3 rounded-xl font-black uppercase text-sm transition-colors">
 Close Window
 </button>
 </div>
 ) : (
 ...
 <input type="text" name="name" value={formData.name} onChange={handleInputChange} required className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 <div>
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec dark:text-white/50">Email Address</label>
 <input type="email" name="email" value={formData.email} onChange={handleInputChange} required className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 <div>
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec dark:text-white/50">Department</label>
 <select name="department" value={formData.department} onChange={handleInputChange} required className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white appearance-none transition cursor-pointer">
 ...
 <input type="text" name="designation" value={formData.designation} onChange={handleInputChange} required placeholder="e.g. Professor of Law" className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 </div>

 <div>
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec dark:text-white/50">Specialisation Area</label>
 <input type="text" name="specialisation" value={formData.specialisation} onChange={handleInputChange} placeholder="e.g. Constitutional Law, Human Rights" className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 ...
 <input type="text" name="office" value={formData.office} onChange={handleInputChange} placeholder="e.g. Block A, Room 101" className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 <div>
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec dark:text-white/50">Contact Phone</label>
 <input type="text" name="phone" value={formData.phone} onChange={handleInputChange} placeholder="e.g. +91 98765 43210" className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 </div>
 ...
 <input type="url" name="linkedin" value={formData.linkedin} onChange={handleInputChange} placeholder="https://linkedin.com/in/..." className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 <div>
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec dark:text-white/50">Google Scholar URL</label>
 <input type="url" name="scholar" value={formData.scholar} onChange={handleInputChange} placeholder="https://scholar.google.com/..." className="w-full bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl p-3.5 font-bold focus:border-themeBorder dark:border-white/5Accent focus:ring-1 focus:ring-themeAccent outline-none text-themeText dark:text-white placeholder:text-themeTextSec dark:text-white/50/50 transition" />
 </div>
 </div>

 <div className="flex items-center gap-4 p-5 bg-gray-100 dark:bg-themeApp border border-themeBorder dark:border-white/5 rounded-xl mt-2">
