...
export default function AdminCareers({ isHubView = false , isEmbedded = false}) {
 ...
 <input required type="text" className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent" value={formData.title} onChange={e => setFormData({...formData, title: e.target.value})} placeholder="e.g. Assistant Professor of Law" />
 </div>
 <div className="flex flex-col gap-2">
 <label className="text-[10px] font-black uppercase tracking-widest text-themeTextSec">Department</label>
 <input required type="text" className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent" value={formData.department} onChange={e => setFormData({...formData, department: e.target.value})} placeholder="e.g. Faculty, Administration" />
 </div>
 </div>
 ...
 <select className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent" value={formData.type} onChange={e => setFormData({...formData, type: e.target.value})}>
 ...
 <select className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent" value={formData.location} onChange={e => setFormData({...formData, location: e.target.value})}>
 ...
 <select className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent" value={formData.is_active ? "active" : "inactive"} onChange={e => setFormData({...formData, is_active: e.target.value === "active"})}>
 ...
 <textarea className="bg-themeElevated/90 backdrop-blur-2xl border border-white/5 rounded-lg px-4 py-3 text-sm text-themeText outline-none focus:border-themeAccent min-h-[200px]" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} placeholder="Job description..."></textarea>
 </div>
