...
export default function AdminDashboard({ isEmbedded = false,  setActiveTab }) {
 ...
 <div className="xl:hidden w-full flex justify-between items-center mb-4 bg-themePanel/85 backdrop-blur-2xl p-3 rounded-2xl border border-gray-200 dark:border-white/5 animate-fade-in">
 ...
 <button type="button" onClick={() => setIsSidebarOpen(true)} className="flex items-center gap-2 bg-themeElevated/90 backdrop-blur-2xl px-3 py-1.5 rounded-lg border border-gray-200 dark:border-white/5 text-themeText hover:border-themeAccent transition-colors">
...
{/* MAIN CONTENT WIDGETS */}
 ...
 xl:col-span-3 flex flex-col min-w-0 pb-28 xl:pb-0 border-l-[length:var(--border-width)] border-gray-200 dark:border-white/5 xl:border-none
 `}>
 ...
 <button type="button" onClick={() => setIsSidebarOpen(false)} className="w-8 h-8 rounded-lg bg-themeElevated/90 backdrop-blur-2xl flex items-center justify-center text-themeTextSec border border-gray-200 dark:border-white/5 hover:text-themeText transition-colors">
