...
export default function SQLStudio({ isEmbedded = false, }) {
 ...
 {/* Header */}
 <div className="bg-themePanel/85 backdrop-blur-2xl border border-gray-200 dark:border-white/5 rounded-2xl p-5 flex items-center justify-between shrink-0">
 ...
 <div className="hidden sm:flex items-center gap-6 border border-gray-200 dark:border-white/5 bg-themeElevated/90 backdrop-blur-2xl px-4 py-2 rounded-lg">
