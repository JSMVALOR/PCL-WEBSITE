...
export default function AdminOverview({ isEmbedded = false }) {
...
{/* Right: Insights & Tasks */}
 ...
 {/* Quick Insights */}
 <div className={`bg-themePanel/85 backdrop-blur-2xl rounded-2xl border border-white/5 p-5 flex flex-col min-h-[160px] relative`}>
 ...
 {/* Pending Tasks */}
 <div className={`bg-themePanel/85 backdrop-blur-2xl rounded-2xl border border-white/5 p-5 flex-1 flex flex-col`}>
 ...
 <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.erpDialog?.alert("Feature coming soon!"); }} className="w-full flex items-center justify-between p-3 rounded-lg bg-themeElevated/90 backdrop-blur-2xl border border-white/5 hover:border-amber-500/50 transition-colors text-left group">
 ...
 <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.erpDialog?.alert("Feature coming soon!"); }} className="w-full flex items-center justify-between p-3 rounded-lg bg-themeElevated/90 backdrop-blur-2xl border border-white/5 hover:border-blue-500/50 transition-colors text-left group">
 <div className="flex items-center gap-3">
 ...
 <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.erpDialog?.alert("Feature coming soon!"); }} className="w-full flex items-center justify-between p-3 rounded-lg bg-themeElevated/90 backdrop-blur-2xl border border-white/5 hover:border-rose-500/50 transition-colors text-left group">
 <div className="flex items-center gap-3">
 ...
 <button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.erpDialog?.alert("Feature coming soon!"); }} className="w-full flex items-center justify-between p-3 rounded-lg bg-themeElevated/90 backdrop-blur-2xl border border-white/5 hover:border-indigo-500/50 transition-colors text-left group">
 <div className="flex items-center gap-3">
