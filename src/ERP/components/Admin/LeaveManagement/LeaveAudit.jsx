...
export default function LeaveAudit({ isEmbedded = false }) {
 ...
 <button type="button" onClick={handleExportReport} className="w-full sm:w-10 h-10 rounded-xl bg-white/40 dark:bg-white/5 backdrop-blur-3xl saturate-[1.8] shadow-sm border border-black/[0.04] dark:border-white/[0.08] flex items-center justify-center text-themeTextSec hover:text-indigo-500 transition-colors shrink-0">
