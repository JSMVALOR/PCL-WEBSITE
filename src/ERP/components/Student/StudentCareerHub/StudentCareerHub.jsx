...
export default function StudentCareerHub() {
 ...
 <i className="fa-solid fa-briefcase text-themeText dark:text-white text-2xl lg:text-3xl"></i>
 </div>
 <div>
 <span className="px-2 lg:px-2.5 py-1 bg-white/20 text-themeText dark:text-white border border-white/30 rounded-md text-[8px] lg:text-[12px] font-medium mb-1.5 lg:mb-2 inline-block">Professional Development</span>
 <h1 className={`${theme.text.display} text-2xl lg:text-3xl tracking-tight text-themeText dark:text-white mb-1`}>Career & Clinics</h1>
