...
export default function Credentials() {
 ...
 <div className="w-full max-w-sm bg-black/5 dark:bg-white/10 backdrop-blur-[80px] border border-black/10 dark:border-white/20 border-2 border-black/10 dark:border-white/20 rounded-2xl overflow-hidden relative flex flex-col group hover:-translate-y-1 transition-transform duration-300">
