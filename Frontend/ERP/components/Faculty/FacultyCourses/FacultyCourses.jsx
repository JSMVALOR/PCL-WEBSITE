...
export default function FacultyCourses({ isEmbedded = false,  setActiveTab }) {
 ...
 return (
 <div className={`w-full animate-fade-in selection:bg-black/5 dark:selection:bg-white/10 ${!isEmbedded ? "min-h-screen bg-themeApp text-themeText dark:text-themeText" : ""}`}>
