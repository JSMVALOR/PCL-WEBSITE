...
export default function AdminFacultyEditorModal({ facultyId, onClose, onSave }) {
 ...
 <p className="text-[14px] font-medium tracking-normal text-themeTextSec">Loading Profile Data...</p>
 </div>
 </div>,
 document.body
 );
 ...
 <h4 className="text-[15px] font-semibold text-themeText tracking-normal mb-4 flex items-center gap-2">
 ...
 <label className="block text-[13px] font-medium mb-1.5 ml-1 text-themeTextSec">Bio / Introduction</label>
 <textarea 
 name="bio" 
 value={formData.bio} 
 onChange={handleInputChange} 
