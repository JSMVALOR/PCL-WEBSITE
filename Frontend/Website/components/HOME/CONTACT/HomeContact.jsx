    ...
    <section className="slide w-full relative flex flex-col overflow-hidden bg-[var(--bg-color)]" ref={ref} {...props}>
      ...
      <div className="container relative z-10 w-full max-w-7xl mx-auto px-4 md:px-12 flex flex-col h-[100svh] md:h-full justify-between pt-[100px] md:pt-[120px] pb-4 md:pb-8">
        ...
        <motion.div 
          ...
          className="mt-4 md:mt-6 flex flex-col w-full z-20 pb-2"
        >
          {/* Architectural Divider */}
          <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-[var(--card-border)] to-transparent mb-4 md:mb-5"></div>
          
          <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-6 mb-2 md:mb-4">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between text-[7px] md:text-[9px] font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] w-full pt-3 border-t border-[var(--card-border)] pb-1">
            <p className="mb-2 md:mb-0 opacity-70">© {new Date().getFullYear()} Prudentia College of Law.</p>
          ...
          {/* JSM VALOR Branding */}
          <div className="w-full flex justify-center items-center mt-3 pb-1 opacity-70 hover:opacity-100 transition-opacity duration-500">
            <span className="text-[8px] md:text-[9px] text-[var(--text-muted)] font-bold uppercase tracking-[0.25em] mr-2">Engineered by</span>
            <a href="https://jsmvalor.in" target="_blank" rel="noopener noreferrer" className="flex items-center">
              <span className="text-[8px] md:text-[9px] font-black tracking-[0.15em]" style={{ 
                color: 'var(--text-color)', 
                fontFamily: '"Inter", sans-serif' 
              }}>
                JSM VALOR<span style={{ color: '#ff2e23', marginLeft: '0.5px' }}>.</span>
              </span>
            </a>
          </div>
        </motion.div>
