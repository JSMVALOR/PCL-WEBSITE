...
export default function CourseBALLB() {
  ...
  // CMS Integration
  const { content, loading } = useSiteContent('/programs/ba-llb', 'program_details');
  ...
  const cms = {
    ...
    title: content?.title || "BA. LL.B",
    title_highlight: content?.title_highlight || "Honors",
    description: content?.description || "An elite integrated undergraduate program merging the profound depths of Humanities with the rigorous frameworks of Law. Designed for visionary leaders.",
    overview_text: content?.overview_text || "The Bachelor of Arts and Bachelor of Legislative Law (BA. LL.B) is a meticulously crafted five-year integrated program. It seamlessly blends the study of history, political science, sociology, and economics with substantive and procedural law. This holistic approach ensures our graduates possess deep socio-legal awareness, crucial for effective advocacy, policy-making, and judicial roles.",
    focus_1: content?.focus_1 || "Constitutional Law & Governance",
    focus_2: content?.focus_2 || "Human Rights & International Law",
    focus_3: content?.focus_3 || "Criminal Law & Criminology",
    focus_4: content?.focus_4 || "Sociology & Political Science Integration",
    focus_5: content?.focus_5 || "Advanced Moot Court & Mock Trials",
    curriculum_m1_title: content?.curriculum_m1_title || "Years 1 & 2",
    curriculum_m1_badge: content?.curriculum_m1_badge || "Foundational",
    curriculum_m1_desc: content?.curriculum_m1_desc || "Political Science, Sociology, Economics, English, Law of Contracts, Torts.",
    curriculum_m2_title: content?.curriculum_m2_title || "Years 3 & 4",
    curriculum_m2_badge: content?.curriculum_m2_badge || "Core Law",
    curriculum_m2_desc: content?.curriculum_m2_desc || "Constitutional Law, Criminal Law, Family Law, Property Law, Environmental Law.",
    curriculum_m3_title: content?.curriculum_m3_title || "Year 5",
    curriculum_m3_badge: content?.curriculum_m3_badge || "Clinical & Advanced",
    curriculum_m3_desc: content?.curriculum_m3_desc || "Moot Court, Drafting & Pleading, Public International Law, Human Rights, Professional Ethics.",
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.contentContainer} ref={contentRef}>
        ...
        <div className="w-full h-[300px] md:h-[500px] rounded-3xl overflow-hidden mb-16 relative flex items-center justify-center group shadow-2xl gsap-fade-up z-10">
          <img decoding="async" loading="lazy" src={classroom1} alt="BA LLB Classroom" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-700" />
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative z-10 flex-col-reverse md:flex-row">
          <div className="md:col-span-2 space-y-12">
            ...
            <section className="mt-16 gsap-fade-up">
              <FeaturedSubjects programId="ba11b000-0000-4000-a000-000000000000" limit={6} />
            </section>
          </div>
